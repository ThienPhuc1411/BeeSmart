                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"><h3 style="Margin:0;font-family:'Josefin Sans', helvetica, arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#2D033A">Chào {{ $mailData['ten'] }},</h3><p style="Margin:0;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;letter-spacing:0;color:#38363A;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;letter-spacing:0;color:#38363A;font-size:14px">Bạn đã tạo thành công cửa hàng {{ $mailData['body'] }} ở hệ thống của chúng tôi.<br><br></p>
                        ...
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;letter-spacing:0;color:#38363A;font-size:14px">Mời bạn click vào <a href="https://docs.google.com/spreadsheets/d/1QjROUbyNCWQdG7TW3mJAXCZMPdaFeJYzRxPBgoC7YjA/edit#gid=0" style="color: red; font-weight: bold">đây</a>để tham khảo mẫu Excel import sản phẩm.<br><br></p>
